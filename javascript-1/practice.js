...
let me = {
	...
	state: "Texas",
	age: 23,
	greeter: function () {return `Hello! My name is ${me.firstName} and I live in ${me.state}`}
}
//////////////////PROBLEM 12////////////////////
...
// Code Here
let doubled = myNumbers.map(function(element, i, arr) {
	return element * 2;
})
//////////////////PROBLEM 15////////////////////
...
// Code Here
let filtered = myNumbers.filter(function(element, i, arr) {
return element > 100;
})
//////////////////PROBLEM 16////////////////////
...
// Code Here
let total = myNumbers.reduce(function(total, element, i, arr) {
...
// Code Here
let myNumbersIndex = []
myNumbers.forEach(function (element, i, arr) {
...
// Code Here
totallyAwesome = people.reduce(function(total, element) {
